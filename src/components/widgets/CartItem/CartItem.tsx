...
export const CartItem: FC<TCartItemProps> = ({
  ...
  return (
    <div className="flex flex-col items-stretch sm:flex-row resp-[gap-y/24/24] sm:justify-between border border-elements dark:border-none dark:bg-dark-surface-1 resp-[px/24/16] resp-[py/24/16]">
