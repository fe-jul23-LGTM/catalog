...
export const ArrowButton:FC<TArrowButtonProps> = ({
  ...
  const arrowStyles = classNames(
    ...
    ${disabled ? 'dark:fill-dark-icons fill-icons' : 'dark:fill-white fill-black'}`,
  );
      ...
      {direction === 'right'
        ? <svg
          ...
          >
            ...
            <path className={arrowStyles} fill-rule="evenodd" clip-rule="evenodd" d="M5.52876 3.52861C5.78911 3.26826 6.21122 3.26826 6.47157 3.52861L10.4716 7.52861C10.7319 7.78896 10.7319 8.21107 10.4716 8.47141L6.47157 12.4714C6.21122 12.7318 5.78911 12.7318 5.52876 12.4714C5.26841 12.2111 5.26841 11.789 5.52876 11.5286L9.05735 8.00001L5.52876 4.47141C5.26841 4.21107 5.26841 3.78896 5.52876 3.52861Z"/>
          </svg>
        : <svg
            width="16"
            height="16"
